...
public class tictactoe extends javax.swing.JFrame {
    ...
    private void gameScore(){
        jlbPlayer1.setText(String.valueOf(xCount));
        jlbComputer.setText(String.valueOf(oCount));
    }
    ...
    private void WinGame(){
        ...
        // Computer
        if(b1 == ("O") && b2 == ("O") && b3 == ("O")){
            JOptionPane.showMessageDialog(this, "Computer Win","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
            oCount++;
            gameScore();
            jButton1.setBackground(Color.YELLOW);
            jButton2.setBackground(Color.YELLOW);
    ...
    private void initComponents() {
        ...
        jlbComputer = new javax.swing.JLabel();
        ...
        jlbPlayer1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jPanel7.add(jlbPlayer1, java.awt.BorderLayout.CENTER);
        ...
        jlbComputer.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jPanel12.add(jlbComputer, java.awt.BorderLayout.CENTER);
        ...
        tbReset.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        ...
        jPanel16.add(tbReset, java.awt.BorderLayout.CENTER);
        ...
        tbExit.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        tbExit.setText("Exit");
        ...
        jPanel17.add(tbExit, java.awt.BorderLayout.CENTER);
    ...
    private javax.swing.JLabel jlbComputer;
